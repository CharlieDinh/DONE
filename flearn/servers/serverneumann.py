...
from flearn.users.userneumann import UserNeumann
...
class FedNeumann(Server):
    def __init__(self, dataset,algorithm, model, batch_size, learning_rate, hyper_learning_rate, L, num_glob_iters,
        ...
        for i in range(total_users):
            ...
            user = UserNeumann(id, train, test, model, batch_size, learning_rate,hyper_learning_rate,L, local_epochs, optimizer)
