...
if __name__ == "__main__":
    ...
    parser.add_argument("--L", type=int, default=0.02, help="Regularization term")
    ...
    parser.add_argument("--algorithm", type=str, default="DANE",choices=["DONE", "GD", "DANE", "Newton", "GT", "PGT", "FEDL","GIANT"])
